...
public class Utils {
    ...
    public static int getScreenPercent(int screenSize, double percent){ return (int)(screenSize*percent); }
    ...
    public static void changeBarColors(Activity activity, int color){
